...
{ // a dummy monster for recolouring
    MONS_CAR, 'C', LIGHTGREY, "car",
    M_CRASH_DOORS | M_UNBREATHING,
    MR_RES_ELEC | MR_RES_PETRIFY | MR_RES_ROTTING
        | mrd(MR_RES_POISON, 3),
    10, MONS_CAR, MONS_CAR, MH_NONLIVING, 60,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 300,
    20, 3, MST_NO_SPELLS, CE_NOCORPSE, S_TRUMPET,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_MISC,
    {TILEP_MONS_UNKNOWN}, TILE_ERROR
},
...
// "B"eetles.
{
    MONS_GOLDEN_SCARAB, 'B', ETC_GOLD, "Golden scarab",
    M_UNIQUE | M_NO_SKELETON,
    MR_VUL_POISON | mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 2)
        | mrd(MR_RES_ACID | MR_RES_NEG, 3) | MR_RES_TORMENT | MR_RES_ROTTING,
    17, MONS_BEETLE, MONS_GOLDEN_SCARAB, MH_NATURAL, MAG_IMMUNE,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 1630,
    30, 20, MST_SCARAB, CE_CLEAN, S_SILENT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(7),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_INSECT,
    {TILEP_MONS_GOLDEN_SCARAB}, TILE_CORPSE_GOLDEN_SCARAB
},
