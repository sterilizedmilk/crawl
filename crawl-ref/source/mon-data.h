...
/* ******************************************************************
 ...
 - Here are the rows:
    - row 1: monster id, display character, display colour, name, name_kor
    - row 2: monster flags
...
{
    // id, glyph, colour, name, name_kor
    MONS_PROGRAM_BUG, 'B', LIGHTRED, "program bug", "프로그램 버그",
    // monster flags
...
{
    MONS_WORKER_ANT, 'a', RED, "worker ant", "일꾼 개미",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_QUEEN_ANT, 'a', LIGHTRED, "queen ant", "여왕 개미",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_SOLDIER_ANT, 'a', WHITE, "soldier ant", "병정 개미",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_FORMICID, 'a', GREEN, "formicid", "포미시드",
...
{
    MONS_ENTROPY_WEAVER, 'a', LIGHTCYAN, "entropy weaver", "엔트로피 방직꾼",
...
{
    MONS_BUTTERFLY, 'b', ETC_JEWEL, "butterfly", "나비",
...
{ // one vault + player transform (Vp ability)
    MONS_VAMPIRE_BAT, 'b', MAGENTA, "vampire bat", "흡혈 박쥐",
...
{
    MONS_FIRE_BAT, 'b', LIGHTRED, "fire bat", "불박쥐",
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_BATTY | M_FLIES,
...
{
    MONS_CAUSTIC_SHRIKE, 'b', LIGHTGREEN, "caustic shrike", "부식성 까치",
...
{
    MONS_SHARD_SHRIKE, 'b', LIGHTBLUE, "shard shrike", "파편 까치",
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_BATTY | M_FLIES,
    mrd(MR_RES_COLD, 2),
...
// centaurs ('c')
{
    MONS_CENTAUR, 'c', BROWN, "centaur", "켄타우로스",
...
{
    MONS_CENTAUR_WARRIOR, 'c', YELLOW, "centaur warrior", "켄타우로스 전사",
...
{
    MONS_YAKTAUR, 'c', RED, "yaktaur", "야크타우로스",
    M_WARM_BLOOD | M_ARCHER | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_YAKTAUR_CAPTAIN, 'c', LIGHTRED, "yaktaur captain", "야크타우로스 대장",
    M_WARM_BLOOD | M_FIGHTER | M_ARCHER | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_SATYR, 'c', LIGHTGREEN, "satyr", "사티로스",
...
// draconians ('d')
{   // Base draconian.
    MONS_DRACONIAN, 'd', BROWN, "draconian", "드라코니언",
...
{
    MONS_BLACK_DRACONIAN, 'd', BLUE, "black draconian", "검은 드라코니언",
...
{
    MONS_YELLOW_DRACONIAN, 'd', YELLOW, "yellow draconian", "노란 드라코니언",
...

{
    ...
    MONS_PALE_DRACONIAN, 'd', CYAN, "pale draconian", "창백한 드라코니언",
    M_COLD_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_RES_STEAM,
...
{
    MONS_GREEN_DRACONIAN, 'd', GREEN, "green draconian", "녹색 드라코니언",
    M_COLD_BLOOD | M_SPEAKS,
    MR_RES_POISON,
...
{
    MONS_PURPLE_DRACONIAN, 'd', MAGENTA, "purple draconian", "보라 드라코니언",
    M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_RED_DRACONIAN, 'd', LIGHTRED, "red draconian", "붉은 드라코니언",
    M_COLD_BLOOD | M_SPEAKS,
    MR_RES_FIRE,
...
{
    MONS_WHITE_DRACONIAN, 'd', WHITE, "white draconian", "흰 드라코니언",
    M_COLD_BLOOD | M_SPEAKS,
    MR_RES_COLD,
...
{
    MONS_GREY_DRACONIAN, 'd', LIGHTGREY, "grey draconian", "회색 드라코니언",
...
{
    MONS_DRACONIAN_STORMCALLER, 'q', BROWN, "draconian stormcaller", "드라코니언 폭풍소환사",
    M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_DRACONIAN_MONK, 'q', BLUE, "draconian monk", "드라코니언 수도승",
...
{
    MONS_DRACONIAN_SHIFTER, 'q', LIGHTCYAN, "draconian shifter", "드라코니언 전이술사",
    M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_DRACONIAN, MONS_DRACONIAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_DRACONIAN_ANNIHILATOR, 'q', LIGHTBLUE, "draconian annihilator", "드라코니언 섬멸자",
    M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_DRACONIAN, MONS_DRACONIAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_DRACONIAN_KNIGHT, 'q', CYAN, "draconian knight", "드라코니언 기사",
    M_FIGHTER | M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_DRACONIAN, MONS_DRACONIAN, MH_NATURAL, 40,
...
{
    MONS_DRACONIAN_SCORCHER, 'q', LIGHTRED, "draconian scorcher", "드라코니언 화염술사",
    M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_DEEP_ELF_KNIGHT, 'e', CYAN, "deep elf knight", "딥 엘프 기사",
...
{
    MONS_DEEP_ELF_ARCHER, 'e', BROWN, "deep elf archer", "딥 엘프 궁수",
    M_WARM_BLOOD | M_ARCHER | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_DEEP_ELF_BLADEMASTER, 'e', LIGHTCYAN, "deep elf blademaster", "딥 엘프 검귀",
...
{
    MONS_DEEP_ELF_MASTER_ARCHER, 'e', LIGHTGREY, "deep elf master archer", "딥 엘프 활의 대가",
...
{
    MONS_DEEP_ELF_MAGE, 'e', MAGENTA, "deep elf mage", "딥 엘프 마법사",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_DEEP_ELF_HIGH_PRIEST, 'e', LIGHTGREEN, "deep elf high priest", "딥 엘프 고위 사제",
...
{
    MONS_DEEP_ELF_DEMONOLOGIST, 'e', YELLOW, "deep elf demonologist", "딥 엘프 악마술사",
...
{
    MONS_DEEP_ELF_ANNIHILATOR, 'e', LIGHTBLUE, "deep elf annihilator", "딥 엘프 섬멸자",
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, 120,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_DEEP_ELF_SORCERER, 'e', LIGHTMAGENTA, "deep elf sorcerer", "딥 엘프 마도사",
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_DEEP_ELF_DEATH_MAGE, 'e', WHITE, "deep elf death mage", "딥 엘프 강령술사",
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_DEEP_ELF_ELEMENTALIST, 'e', LIGHTRED, "deep elf elementalist", "딥 엘프 원소술사",
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_WANDERING_MUSHROOM, 'f', BROWN, "wandering mushroom", "방황하는 버섯",
    M_NO_FLAGS,
    MR_RES_POISON,
...
{
    MONS_DEATHCAP, 'f', LIGHTMAGENTA, "deathcap", "죽음의 갓버섯",
    M_NO_FLAGS,
    MR_RES_COLD,
...
{
    MONS_THORN_HUNTER, 'f', WHITE, "thorn hunter", "가시 사냥꾼",
    M_SEE_INVIS,
...
{
    MONS_SHAMBLING_MANGROVE, 'f', LIGHTRED, "shambling mangrove", "꾸물거리는 맹그로브",
    M_NO_FLAGS,
    MR_RES_POISON,
...
{
    MONS_VINE_STALKER, 'f', GREEN, "vine stalker", "바인 스토커",
...
{
    MONS_GOBLIN, 'g', LIGHTGREY, "goblin", "고블린",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_HOBGOBLIN, 'g', BROWN, "hobgoblin", "홉고블린",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_GNOLL_SHAMAN, 'g', WHITE, "gnoll shaman", "놀 주술사",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_GNOLL_SERGEANT, 'g', CYAN, "gnoll sergeant", "놀 분대장",
...
{
    MONS_BOGGART, 'g', MAGENTA, "boggart", "보가트",
...
{
    MONS_DEEP_DWARF, 'g', LIGHTBLUE, "deep dwarf", "딥 드워프",
...
{
    MONS_HOWLER_MONKEY, 'h', LIGHTGREEN, "howler monkey", "고함 원숭이",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_HOG, 'h', LIGHTMAGENTA, "hog", "돼지",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_HELL_HOUND, 'h', CYAN, "hell hound", "지옥 사냥개",
...
{
    MONS_DOOM_HOUND, 'h', GREEN, "doom hound", "파멸 사냥개",
    M_SEE_INVIS | M_UNBLINDABLE | M_BLOOD_SCENT,
    MR_NO_FLAGS,
...
{
    MONS_RAIJU, 'h', LIGHTCYAN, "raiju", "뇌수",
    M_SEE_INVIS | M_UNBLINDABLE | M_BLOOD_SCENT,
    mrd(MR_RES_ELEC, 3),
...
{
    MONS_HELL_HOG, 'h', LIGHTRED, "hell hog", "지옥의 돼지",
    M_NO_FLAGS,
    mrd(MR_RES_FIRE, 2),
...
{   // effect of porkalator cast on holies
    MONS_HOLY_SWINE, 'h', YELLOW, "holy swine", "성스러운 돼지",
    M_FLIES,
    MR_NO_FLAGS,
...
{ // a dummy monster for recolouring
    MONS_FELID, 'h', MAGENTA, "felid", "펠리드",
...
{
    MONS_POLAR_BEAR, 'h', LIGHTBLUE, "polar bear", "북극곰",
    M_WARM_BLOOD,
    MR_RES_COLD,
...
{
    MONS_BLACK_BEAR, 'h', BLUE, "black bear", "흑곰",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
// spriggans ('i')
{
    MONS_SPRIGGAN, 'i', LIGHTGREY, "spriggan", "스프리건",
...
{   // both the guy and his ride as one monster
    MONS_SPRIGGAN_RIDER, 'i', LIGHTBLUE, "spriggan rider", "스프리건 기수",
...
{
    MONS_SPRIGGAN_DRUID, 'i', GREEN, "spriggan druid", "스프리건 드루이드",
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_NATURAL, 100,
...
{
    MONS_SPRIGGAN_BERSERKER, 'i', LIGHTRED, "spriggan berserker", "스프리건 광전사",
...
{
    MONS_SPRIGGAN_AIR_MAGE, 'i', LIGHTCYAN, "spriggan air mage", "스프리건 대기술사",
...
{
    MONS_SPRIGGAN_DEFENDER, 'i', YELLOW, "spriggan defender", "스프리건 수호자",
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_FIGHTER,
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_NATURAL, 140,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SWAMP_DRAKE, 'k', BROWN, "swamp drake", "늪지 드레이크",
...
{
    MONS_RIME_DRAKE, 'k', BLUE, "rime drake", "서리 드레이크",
    M_WARM_BLOOD | M_FLIES,
    MR_RES_COLD,
...
{
    MONS_WIND_DRAKE, 'k', WHITE, "wind drake", "바람 드레이크",
    M_WARM_BLOOD | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_LINDWURM, 'k', LIGHTRED, "lindwurm", "린드웜",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_DEATH_DRAKE, 'k', LIGHTGREY, "death drake", "죽음의 드레이크",
...
{
    MONS_FRILLED_LIZARD, 'l', GREEN, "frilled lizard", "목도리 도마뱀",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_LEOPARD_GECKO, 'l', YELLOW, "leopard gecko", "표범 도마뱀붙이",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_IGUANA, 'l', BLUE, "iguana", "이구아나",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_BASILISK, 'l', MAGENTA, "basilisk", "바실리스크",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_WYVERN, 'l', LIGHTGREEN, "wyvern", "와이번",
    M_WARM_BLOOD | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_KOMODO_DRAGON, 'l', LIGHTRED, "komodo dragon", "코모도왕도마뱀",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
// merfolk ('m')
{
    MONS_MERFOLK, 'm', LIGHTRED, "merfolk", "머포크",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_MERFOLK_IMPALER, 'm', YELLOW, "merfolk impaler", "머포크 창술사",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_MERFOLK_JAVELINEER, 'm', WHITE, "merfolk javelineer", "머포크 투창병",
    M_WARM_BLOOD | M_ARCHER | M_DONT_MELEE | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_MERFOLK_AQUAMANCER, 'm', GREEN, "merfolk aquamancer", "머포크 파도술사",
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_NO_FLAGS,
...
{
    MONS_MERFOLK_SIREN, 'm', CYAN, "merfolk siren", "머포크 사이렌",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_MERFOLK_AVATAR, 'm', LIGHTCYAN, "merfolk avatar", "머포크 인도자",
...
{
    MONS_WATER_NYMPH, 'm', MAGENTA, "water nymph", "물의 요정",
...
// rotting monsters ('n')
{
    MONS_BOG_BODY, 'n', GREEN, "bog body", "늪지 시체",
    M_NO_ZOMBIE,
...
{
    MONS_NECROPHAGE, 'n', LIGHTGREY, "necrophage", "시체 포식자",
    M_NO_ZOMBIE,
    MR_RES_COLD,
...
{
    MONS_ORC_WIZARD, 'o', MAGENTA, "orc wizard", "오크 마법사",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_ORC_PRIEST, 'o', GREEN, "orc priest", "오크 사제",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_ORC_WARRIOR, 'o', YELLOW, "orc warrior", "오크 전사",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_ORC_KNIGHT, 'o', CYAN, "orc knight", "오크 기사",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_ORC_WARLORD, 'o', LIGHTCYAN, "orc warlord", "오크 전쟁군주",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_ORC_SORCERER, 'o', LIGHTMAGENTA, "orc sorcerer", "오크 마도사",
...
{
    MONS_ORC_HIGH_PRIEST, 'o', LIGHTGREEN, "orc high priest", "오크 고위 사제",
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD,
    MR_NO_FLAGS,
...
#if TAG_MAJOR_VERSION == 34
{
    MONS_LAVA_ORC, 'o', RED, "lava orc", "용암 오크",
...
// humans ('p')
{
    MONS_HUMAN, 'p', LIGHTGREY, "human", "인간",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_HELL_KNIGHT, 'p', RED, "hell knight", "지옥의 기사",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    mrd(MR_RES_FIRE, 3),
...
{
    MONS_DEATH_KNIGHT, 'p', GREEN, "death knight", "죽음의 기사",
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_NECROMANCER, 'p', WHITE, "necromancer", "강령술사",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_WIZARD, 'p', MAGENTA, "wizard", "마법사",
...
{
    MONS_VAULT_GUARD, 'p', CYAN, "vault guard", "보물창고 수호병",
...
{
    MONS_VAULT_SENTINEL, 'p', LIGHTBLUE, "vault sentinel", "보물창고 보초병",
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
    ...
    {
    MONS_VAULT_WARDEN, 'p', LIGHTRED, "vault warden", "보물창고 간수장",
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_IRONBRAND_CONVOKER, 'p', YELLOW, "ironbrand convoker", "강철인장 소환사",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_IMPERIAL_MYRMIDON, 'p', LIGHTCYAN, "imperial myrmidon", "제국 미르미돈",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 60,
...
{
    MONS_SERVANT_OF_WHISPERS, 'p', BLUE, "servant of whispers", "속삭임의 하수인",
    M_SPEAKS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_RAGGED_HIEROPHANT, 'p', LIGHTMAGENTA, "ragged hierophant", "남루한 사제장",
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
...
{
    MONS_IRONHEART_PRESERVER, 'p', LIGHTGREEN, "ironheart preserver", "강철심장 수호자",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SHAPESHIFTER, 'p', LIGHTRED, "shapeshifter", "변신수",
...
{
    MONS_GLOWING_SHAPESHIFTER, 'p', LIGHTRED, "glowing shapeshifter", "빛나는 변신수",
    M_NO_SKELETON | M_NO_ZOMBIE,
    MR_NO_FLAGS,
...
{
    MONS_KILLER_KLOWN, 'p', ETC_RANDOM, "Killer Klown", "살인 광대",
...
{ // dummy; spawns in a single vault.
    MONS_DEMIGOD, 'p', YELLOW, "demigod", "반신",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
...
{ // dummy... literally; single vault
    MONS_HALFLING, 'p', LIGHTGREY, "halfling", "하플링",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
...
{
    MONS_RIVER_RAT, 'r', LIGHTGREEN, "river rat", "강가 쥐",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_HELL_RAT, 'r', LIGHTRED, "hell rat", "지옥 쥐",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_PORCUPINE, 'r', BLUE, "porcupine", "고슴도치",
...
{
    MONS_GIANT_COCKROACH, 's', BROWN, "giant cockroach", "거대 바퀴벌레",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_SCORPION, 's', YELLOW, "scorpion", "전갈",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_EMPEROR_SCORPION, 's', LIGHTGREY, "emperor scorpion", "황제 전갈",
    M_NO_SKELETON,
    MR_RES_POISON,
...
{
    MONS_DEATH_SCARAB, 's', BLUE, "death scarab", "죽음의 풍뎅이",
...
{
    MONS_TARANTELLA, 's', LIGHTMAGENTA, "tarantella", "타란튤라",
...
{
    MONS_JUMPING_SPIDER, 's', LIGHTBLUE, "jumping spider", "깡총 거미",
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
...
{
    MONS_WOLF_SPIDER, 's', WHITE, "wolf spider", "늑대거미",
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
...
{
    MONS_REDBACK, 's', LIGHTRED, "redback", "붉은등거미",
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
...
{
    MONS_DEMONIC_CRAWLER, 's', LIGHTGREEN, "demonic crawler", "악마의 벌레",
...
{
    MONS_ORB_SPIDER, 's', MAGENTA, "orb spider", "구체 거미",
...
{
    MONS_CROCODILE, 't', BROWN, "crocodile", "크로커다일",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_ALLIGATOR, 't', LIGHTBLUE, "alligator", "엘리게이터",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_SNAPPING_TURTLE, 't', GREEN, "snapping turtle", "늑대거북",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_ALLIGATOR_SNAPPING_TURTLE, 't', LIGHTGREEN, "alligator snapping turtle", "악어거북",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_FIRE_CRAB, 't', LIGHTRED, "fire crab", "화염 게",
    M_NO_SKELETON,
...
{
    MONS_GHOST_CRAB, 't', LIGHTGREY, "ghost crab", "유령 게",
    M_NO_SKELETON,
    MR_NO_FLAGS,
...
{
    MONS_APOCALYPSE_CRAB, 't', WHITE, "apocalypse crab", "묵시의 게",
    M_NO_SKELETON | M_SEE_INVIS,
...
{
    MONS_UGLY_THING, 'u', COLOUR_UNDEF, "ugly thing", "흉측한 것",
...
{
    MONS_VERY_UGLY_THING, 'u', COLOUR_UNDEF, "very ugly thing", "매우 흉측한 것",
    M_WARM_BLOOD | M_HERD | M_NO_GEN_DERIVED | M_GHOST_DEMON,
    MR_NO_FLAGS,
...
// vortices ('v')
{
    MONS_FIRE_VORTEX, 'v', RED, "fire vortex", "화염 소용돌이",
...
{
    MONS_SPATIAL_VORTEX, 'v', ETC_RANDOM, "spatial vortex", "공간의 소용돌이",
...
{
    MONS_SPATIAL_MAELSTROM, 'v', YELLOW, "spatial maelstrom", "큰 공간의 소용돌이",
...
{
    MONS_INSUBSTANTIAL_WISP, 'v', LIGHTGREY, "insubstantial wisp", "실체가 없는 위습",
...
{ // miscast only
    MONS_TWISTER, 'v', ETC_AIR, "twister", "회오리",
...
{
    MONS_SWAMP_WORM, 'w', BROWN, "swamp worm", "늪지렁이",
...
{
    MONS_TYRANT_LEECH, 'w', RED, "tyrant leech", "폭군 거머리",
...
{
    MONS_DART_SLUG, 'w', CYAN, "dart slug", "다트 민달팽이",
    M_NO_SKELETON,
    MR_VUL_POISON,
...
{
    MONS_TORPOR_SNAIL, 'w', GREEN, "torpor snail", "무기력함의 달팽이",
    M_NO_SKELETON,
    MR_NO_FLAGS,
...
{
    MONS_ELEPHANT_SLUG, 'w', WHITE, "elephant slug", "코끼리 민달팽이",
...
{
    MONS_UNSEEN_HORROR, 'x', MAGENTA, "unseen horror", "보이지 않는 공포",
...
{
    MONS_ABOMINATION_SMALL, 'x', LIGHTRED, "small abomination", "작은 흉물",
    M_NO_REGEN,
    MR_NO_FLAGS,
...
{
    MONS_CRAWLING_CORPSE, 'x', BROWN, "crawling corpse", "기어다니는 시체",
...
{
    MONS_MACABRE_MASS, 'x', BROWN, "macabre mass", "끔찍한 덩어리",
    M_NO_EXP_GAIN | M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_ANCIENT_ZYME, 'x', GREEN, "ancient zyme", "고대의 병원균",
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_WORLDBINDER, 'x', CYAN, "worldbinder", "차원연결체",
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
...
// flying insects ('y')
{
    MONS_KILLER_BEE, 'y', BROWN, "killer bee", "킬러 비",
...
{
    MONS_QUEEN_BEE, 'y', LIGHTMAGENTA, "queen bee", "여왕벌",
    M_NO_SKELETON | M_FLIES,
    MR_VUL_POISON,
...
{
    MONS_VAMPIRE_MOSQUITO, 'y', LIGHTGREY, "vampire mosquito", "흡혈 모기",
...
{
    MONS_HORNET, 'y', YELLOW, "hornet", "말벌",
    M_NO_SKELETON | M_FLIES,
    MR_VUL_POISON,
...
{
    MONS_MELIAI, 'y', GREEN, "meliai", "멜리아이",
    M_NO_SKELETON | M_FLIES,
    MR_VUL_POISON,
...
{
    MONS_SPARK_WASP, 'y', LIGHTCYAN, "spark wasp", "전격 말벌",
    M_NO_SKELETON | M_FLIES,
...
{
    MONS_GHOST_MOTH, 'y', MAGENTA, "ghost moth", "유령 나방",
...
{
    MONS_MOTH_OF_WRATH, 'y', LIGHTRED, "moth of wrath", "격노의 나방",
    M_NO_SKELETON | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_SKELETAL_WARRIOR, 'z', CYAN, "skeletal warrior", "해골 전사",
    M_FIGHTER,
    MR_RES_COLD,
...
{
    MONS_ANCIENT_CHAMPION, 'z', LIGHTCYAN, "ancient champion", "고대의 영웅",
    M_FIGHTER,
    MR_RES_COLD,
...
{
    MONS_FLYING_SKULL, 'z', WHITE, "flying skull", "날아다니는 해골",
...
{
    MONS_CURSE_SKULL, 'z', LIGHTMAGENTA, "curse skull", "저주의 해골",
...
{
    MONS_CURSE_TOE, 'z', LIGHTGREEN, "curse toe", "저주의 발가락",
    M_SEE_INVIS | M_SPEAKS | M_FLIES,
...
{
    MONS_CHERUB, 'A', LIGHTBLUE, "cherub", "케루빔",
...
{
    MONS_SERAPH, 'A', LIGHTMAGENTA, "seraph", "세라프",
...
{
    MONS_PROFANE_SERVITOR, 'A', RED, "profane servitor", "타천사",
    M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_FLIES,
...
{
    MONS_CYCLOPS, 'C', YELLOW, "cyclops", "키클롭스",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_FIRE_GIANT, 'C', RED, "fire giant", "화염 거인",
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_FIRE, 2),
...
{
    MONS_FROST_GIANT, 'C', LIGHTBLUE, "frost giant", "서리 거인",
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_STONE_GIANT, 'C', LIGHTGREY, "stone giant", "바위 거인", 
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_TITAN, 'C', MAGENTA, "titan", "타이탄", 
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_ELEC, 3),
...
{
    MONS_JUGGERNAUT, 'C', LIGHTGREEN, "juggernaut", "저거너트",
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_IRON_GIANT, 'C', CYAN, "iron giant", "강철 거인",
...
{
    MONS_FIRE_DRAGON, 'D', LIGHTRED, "fire dragon", "화염 용",
    M_WARM_BLOOD | M_FLIES,
...
{
    MONS_HYDRA, 'D', LIGHTGREEN, "hydra", "히드라",
...
{
    MONS_ICE_DRAGON, 'D', WHITE, "ice dragon", "얼음 용",
    M_COLD_BLOOD | M_FLIES,
...
{
    MONS_STEAM_DRAGON, 'D', BLUE, "steam dragon", "증기 용",
    M_WARM_BLOOD | M_FLIES,
    MR_RES_STEAM,
...
{
    MONS_SWAMP_DRAGON, 'D', BROWN, "swamp dragon", "늪지 용",
    M_WARM_BLOOD | M_FLIES,
    MR_RES_POISON,
...
{
    MONS_ACID_DRAGON, 'D', GREEN, "acid dragon", "산성 용",
    M_WARM_BLOOD | M_FLIES,
...
{
    MONS_QUICKSILVER_DRAGON, 'D', LIGHTCYAN, "quicksilver dragon", "수은 용",
...
{
    MONS_IRON_DRAGON, 'D', CYAN, "iron dragon", "강철 용",
...
{
    MONS_STORM_DRAGON, 'D', LIGHTBLUE, "storm dragon", "폭풍 용",
    M_WARM_BLOOD | M_FLIES,
...
{
    MONS_GOLDEN_DRAGON, 'D', YELLOW, "golden dragon", "황금 용",
    M_SEE_INVIS | M_WARM_BLOOD | M_FLIES,
...
{
    MONS_SHADOW_DRAGON, 'D', MAGENTA, "shadow dragon", "그림자 용",
...
{
    MONS_BONE_DRAGON, 'D', LIGHTGREY, "bone dragon", "뼈다귀 용",
    M_SEE_INVIS | M_FLIES,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_PEARL_DRAGON, 'D', ETC_HOLY, "pearl dragon", "진주 용",
    M_SEE_INVIS | M_WARM_BLOOD | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_EARTH_ELEMENTAL, 'E', ETC_EARTH, "earth elemental", "대지 정령",
    M_NO_FLAGS,
...
{
    MONS_FIRE_ELEMENTAL, 'E', ETC_FIRE, "fire elemental", "불 정령",
    M_INSUBSTANTIAL,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_RES_ELEC
    | MR_VUL_WATER,
...
{
    MONS_WATER_ELEMENTAL, 'E', ETC_WATER, "water elemental", "물 정령",
    M_NO_FLAGS,
...
{
    MONS_AIR_ELEMENTAL, 'E', ETC_AIR, "air elemental", "대기 정령",
...
{
    MONS_IRON_ELEMENTAL, 'E', ETC_IRON, "iron elemental", "강철 정령",
    M_NO_FLAGS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
...
{
    MONS_ELEMENTAL_WELLSPRING, 'E', LIGHTCYAN, "elemental wellspring", "정령의 우물샘",
    M_FAST_REGEN,
    MR_RES_ELEC,
...
{
    MONS_BULLFROG, 'F', GREEN, "bullfrog", "황소 개구리",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_SPINY_FROG, 'F', YELLOW, "spiny frog", "가시 개구리",
    M_COLD_BLOOD,
    MR_RES_POISON,
...
{
    MONS_BLINK_FROG, 'F', LIGHTGREEN, "blink frog", "깜빡이 개구리",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
// dummy for recolouring
{
    MONS_BARACHI, 'F', LIGHTCYAN, "barachi", "바라키",
...
// eyes ('G')
{
    MONS_FLOATING_EYE, 'G', WHITE, "floating eye", "떠다니는 눈알",
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_EYE_OF_DRAINING, 'G', LIGHTGREY, "eye of draining", "흡수의 눈알",
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_GLOWING_ORANGE_BRAIN, 'G', LIGHTRED, "glowing orange brain", "빛나는 주황색 뇌",
...
{
    MONS_GREAT_ORB_OF_EYES, 'G', LIGHTGREEN, "great orb of eyes", "거대한 눈알의 구체",
    M_SEE_INVIS | M_FLIES,
    MR_RES_POISON,
...
{
    MONS_SHINING_EYE, 'G', LIGHTMAGENTA, "shining eye", "빛나는 눈알",
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_EYE_OF_DEVASTATION, 'G', YELLOW, "eye of devastation", "황폐의 눈알",
    M_SEE_INVIS | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_GOLDEN_EYE, 'G', ETC_GOLD, "golden eye", "황금 눈알",
...
// hybrids ('H')
{
    MONS_HIPPOGRIFF, 'H', BROWN, "hippogriff", "히포그리프",
...
{
    MONS_MANTICORE, 'H', RED, "manticore", "맨티코어",
    M_WARM_BLOOD | M_HYBRID | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_MINOTAUR, 'H', LIGHTRED, "minotaur", "미노타우르스",
...
{
    MONS_SPHINX, 'H', LIGHTGREY, "sphinx", "스핑크스",
...
{
    MONS_MUTANT_BEAST, 'H', MAGENTA, "mutant beast", "돌연변이 짐승",
...
{
    MONS_ANCESTOR, 'R', LIGHTCYAN, "ancestor", "선조",
...
{
    MONS_ANCESTOR_KNIGHT, 'R', LIGHTCYAN, "knight", "기사",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD,
...
{
    MONS_ANCESTOR_BATTLEMAGE, 'R', LIGHTCYAN, "battlemage", "전투 마법사",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD,
...
{
    MONS_ANCESTOR_HEXER, 'R', LIGHTCYAN, "hexer", "주술사",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD,
...
// jellies ('J')
{
    MONS_OOZE, 'J', LIGHTGREY, "ooze", "진흙괴물",
...
{
    MONS_JELLY, 'J', LIGHTRED, "jelly", "젤리",
...
{
    MONS_SLIME_CREATURE, 'J', GREEN, "slime creature", "슬라임 덩어리",
    M_FAST_REGEN | M_HERD,
    MR_RES_POISON,
...
{
    MONS_AZURE_JELLY, 'J', LIGHTBLUE, "azure jelly", "하늘빛 젤리",
...
{
    MONS_DEATH_OOZE, 'J', MAGENTA, "death ooze", "죽음의 점액",
    M_SEE_INVIS | M_UNBLINDABLE | M_EAT_DOORS,
...
{
    MONS_ACID_BLOB, 'J', LIGHTCYAN, "acid blob", "산성 방울",
...
// kobolds ('K')
{
    MONS_KOBOLD, 'K', BROWN, "kobold", "코볼드",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_BIG_KOBOLD, 'K', YELLOW, "big kobold", "큰 코볼드",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_KOBOLD_DEMONOLOGIST, 'K', MAGENTA, "kobold demonologist", "코볼드 악마학자",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_ANCIENT_LICH, 'L', WHITE, "ancient lich", "고대 리치",
    M_SEE_INVIS | M_SPEAKS,
...
{
    MONS_REVENANT, 'L', CYAN, "revenant", "사령",
    M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_HALAZID_WARLOCK, 'L', GREEN, "halazid warlock", "할라지드 흑마도사",
    M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_COLD, 2),
...
// mummies ('M')
{
    MONS_MUMMY, 'M', LIGHTGREY, "mummy", "미라",
    M_NO_FLAGS,
...
{
    MONS_GUARDIAN_MUMMY, 'M', YELLOW, "guardian mummy", "미라 수호병",
...
{
    MONS_GREATER_MUMMY, 'M', WHITE, "greater mummy", "위대한 미라",
    M_SEE_INVIS | M_SPEAKS,
    MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_MUMMY_PRIEST, 'M', RED, "mummy priest", "미라 사제",
    M_SEE_INVIS | M_SPEAKS,
    MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_NAGA_MAGE, 'N', MAGENTA, "naga mage", "나가 마법사",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
...
{
    MONS_NAGA_SHARPSHOOTER, 'N', LIGHTGRAY, "naga sharpshooter", "나가 명사수",
    M_SEE_INVIS | M_WARM_BLOOD
...
{
    MONS_NAGA_RITUALIST, 'N', BROWN, "naga ritualist", "나가 의식술사",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
    14, MONS_NAGA, MONS_NAGA, MH_NATURAL, 60,
...
{
    MONS_NAGA_WARRIOR, 'N', BLUE, "naga warrior", "나가 전사",
...
{
    MONS_NAGARAJA, 'N', LIGHTMAGENTA, "nagaraja", "나가라쟈",
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
...
{
    MONS_TWO_HEADED_OGRE, 'O', LIGHTRED, "two-headed ogre", "쌍두 오우거",
    M_WARM_BLOOD | M_TWO_WEAPONS | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_OGRE_MAGE, 'O', MAGENTA, "ogre mage", "오우거 마법사",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_DEMONIC_PLANT, 'P', ETC_RANDOM, "demonic plant", "악령 들린 잡초",
    M_STATIONARY | M_NOT_DANGEROUS,
    MR_RES_POISON,
...
{
    MONS_WITHERED_PLANT, 'P', DARKGREY, "withered plant", "말라 비틀어진 잡초",
    M_STATIONARY | M_NOT_DANGEROUS,
    mrd(MR_RES_POISON, 3),
...
{
    MONS_OKLOB_SAPLING, 'P', LIGHTCYAN, "oklob sapling", "오클롭 묘목",
    M_STATIONARY,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
...
{
    MONS_OKLOB_PLANT, 'P', LIGHTGREEN, "oklob plant", "오클롭 식물",
    M_STATIONARY,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
...
{
    MONS_BURNING_BUSH, 'P', RED, "burning bush", "불타는 덤불",
...
{
    MONS_TOADSTOOL, 'P', COLOUR_UNDEF, "toadstool", "독버섯",
...
{
    MONS_FUNGUS, 'P', LIGHTGREY, "fungus", "곰팡이",
    M_NOT_DANGEROUS | M_STATIONARY,
    MR_RES_POISON,
...
{
    MONS_BALLISTOMYCETE, 'P', MAGENTA, "ballistomycete", "폭발성 진균류",
    M_NOT_DANGEROUS | M_STATIONARY,
    MR_RES_POISON,
...
{
    MONS_HYPERACTIVE_BALLISTOMYCETE, 'P', LIGHTRED, "hyperactive ballistomycete", "활성화된 폭발성 진균류",
...
{
    MONS_BRIAR_PATCH, 'P', YELLOW, "briar patch", "가시덤불",
...
// tengu ('Q')
{
    MONS_TENGU, 'Q', LIGHTBLUE, "tengu", "텐구",
...
{
    MONS_TENGU_CONJURER, 'Q', BLUE, "tengu conjurer", "텐구 요술사",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_TENGU_WARRIOR, 'Q', CYAN, "tengu warrior", "텐구 전사",
...
{
    MONS_TENGU_REAVER, 'Q', LIGHTMAGENTA, "tengu reaver", "텐구 약탈자",
...
{
    MONS_RAKSHASA, 'R', YELLOW, "rakshasa", "락샤사",
    M_SEE_INVIS,
    MR_RES_POISON,
...
{
    MONS_DRYAD, 'R', LIGHTGREEN, "dryad", "드라이어드",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_VUL_FIRE,
...
{
    MONS_SNAPLASHER_VINE, 'w', LIGHTGREEN, "snaplasher vine", "철썩 덩굴",
    M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO,
    MR_RES_POISON,
    ...
    {
    MONS_SNAPLASHER_VINE_SEGMENT, '*', LIGHTGREEN, "snaplasher vine segment", "철썩 덩굴의 일부",
...
{
    MONS_BALL_PYTHON, 'S', GREEN, "ball python", "비단뱀",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_ADDER, 'S', LIGHTGREEN, "adder", "살무사",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_WATER_MOCCASIN, 'S', BROWN, "water moccasin", "물뱀",
    M_COLD_BLOOD,
    MR_RES_POISON,
...
{
    MONS_BLACK_MAMBA, 'S', BLUE, "black mamba", "블랙 맘바",
    M_COLD_BLOOD,
    MR_RES_POISON,
...
{
    MONS_SEA_SNAKE, 'S', LIGHTCYAN, "sea snake", "바다뱀",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_ANACONDA, 'S', LIGHTGREY, "anaconda", "아나콘다",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_GUARDIAN_SERPENT, 'S', WHITE, "guardian serpent", "수호자 구렁이",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
...
{
    MONS_SHOCK_SERPENT, 'S', LIGHTBLUE, "shock serpent", "전격 구렁이",
    M_COLD_BLOOD,
    mrd(MR_RES_ELEC, 3),
...
{
    MONS_MANA_VIPER, 'S', MAGENTA, "mana viper", "마나 독사",
...
{
    MONS_IRON_TROLL, 'T', CYAN, "iron troll", "강철 트롤",
    M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN,
    MR_RES_FIRE | MR_RES_COLD,
...
{
    MONS_DEEP_TROLL, 'T', YELLOW, "deep troll", "딥 트롤",
...
{
    MONS_DEEP_TROLL_EARTH_MAGE, 'T', MAGENTA, "deep troll earth mage", "딥 트롤 대지술사",
...
{
    MONS_DEEP_TROLL_SHAMAN, 'T', WHITE, "deep troll shaman", "딥 트롤 주술사",
    M_WARM_BLOOD | M_SEE_INVIS | M_UNBLINDABLE | M_SPEAKS,
    MR_NO_FLAGS,
...
// vampires ('V')
{
    MONS_VAMPIRE, 'V', RED, "vampire", "뱀파이어",
...
{
    MONS_VAMPIRE_KNIGHT, 'V', CYAN, "vampire knight", "뱀파이어 기사",
...
{
    MONS_VAMPIRE_MAGE, 'V', MAGENTA, "vampire mage", "뱀파이어 마법사",
...
{
    MONS_JIANGSHI, 'V', YELLOW, "jiangshi", "강시",
...
{
    MONS_PHANTOM, 'W', BLUE, "phantom", "환영",
    M_INSUBSTANTIAL | M_FLIES,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_HUNGRY_GHOST, 'W', GREEN, "hungry ghost", "굶주린 유령",
...
{
    MONS_FLAYED_GHOST, 'W', RED, "flayed ghost", "갈기갈기 찢긴 유령",
...
{
    MONS_PLAYER_GHOST, 'W', WHITE, "player ghost", "플레이어 유령",
...
{
    MONS_SHADOW, 'W', MAGENTA, "shadow", "그림자",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    mrd(MR_RES_COLD, 3),
...
{
    MONS_SILENT_SPECTRE, 'W', CYAN, "silent spectre", "정적의 악령",
...
{
    MONS_DROWNED_SOUL, 'W', LIGHTCYAN, "drowned soul", "익사한 영혼",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_SPEAKS | M_FLIES,
    mrd(MR_RES_COLD, 3),
...
{
    MONS_WRAITH, 'W', LIGHTGREY, "wraith", "망령",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_RES_COLD,
...
{
    MONS_SHADOW_WRAITH, 'W', LIGHTMAGENTA, "shadow wraith", "그림자 망령",
...
{
    MONS_FREEZING_WRAITH, 'W', LIGHTBLUE, "freezing wraith", "냉기 망령",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
...
{
    MONS_EIDOLON, 'W', BROWN, "eidolon", "에이돌론",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_RES_COLD,
...
{
    MONS_PHANTASMAL_WARRIOR, 'W', LIGHTGREEN, "phantasmal warrior", "환영 전사",
...
{
    MONS_ABOMINATION_LARGE, 'X', LIGHTRED, "large abomination", "커다란 흉물",
    M_NO_REGEN,
    MR_NO_FLAGS,
...
{
    MONS_THRASHING_HORROR, 'X', YELLOW, "thrashing horror", "몸부림치는 공포",
...
{
    MONS_TENTACLED_MONSTROSITY, 'X', GREEN, "tentacled monstrosity", "촉수괴물",
    M_SEE_INVIS,
...
{
    MONS_ORB_GUARDIAN, 'X', MAGENTA, "Orb Guardian", "오브 수호자",
...
{
    MONS_TENTACLED_STARSPAWN, 'X', LIGHTCYAN, "tentacled starspawn", "촉수투성이 별",
    M_SEE_INVIS,
    MR_NO_FLAGS,
...
{
    MONS_STARSPAWN_TENTACLE, 'w', LIGHTCYAN, "starspawn tentacle", "별의 촉수",
...
{
    MONS_STARSPAWN_TENTACLE_SEGMENT, '*', LIGHTCYAN, "starspawn tentacle segment", "별의 촉수 일부",
...
{
    MONS_STARCURSED_MASS, 'X', BLUE, "starcursed mass", "저주받은 별덩어리",
...
{
    MONS_DREAM_SHEEP, 'Y', CYAN, "dream sheep", "꿈 양",
    M_WARM_BLOOD | M_HERD,
    MR_NO_FLAGS,
...
{
    MONS_DEATH_YAK, 'Y', YELLOW, "death yak", "죽음의 야크",
    M_WARM_BLOOD | M_HERD,
    MR_NO_FLAGS,
...
{
    MONS_CATOBLEPAS, 'Y', MAGENTA, "catoblepas",  "카토블레파스",
    M_WARM_BLOOD,
    MR_RES_PETRIFY,
...
{
    MONS_ELEPHANT, 'Y', GREEN, "elephant", "코끼리",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_DIRE_ELEPHANT, 'Y', BLUE, "dire elephant", "난폭한 코끼리",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_HELLEPHANT, 'Y', LIGHTRED, "hellephant", "지옥 코끼리",
    M_WARM_BLOOD,
    MR_NO_FLAGS,
...
{
    MONS_ICE_BEAST, 'Y', LIGHTBLUE, "ice beast", "얼음 짐승",
    M_NO_FLAGS,
...
{
    MONS_SKY_BEAST, 'Y', LIGHTCYAN, "sky beast", "하늘 짐승",
    M_NO_SKELETON | M_FLIES,
    mrd(MR_RES_ELEC, 3),
...
{
    MONS_SKELETON, 'Z', LIGHTGREY, "skeleton", "해골",
    M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_SIMULACRUM, 'Z', LIGHTBLUE, "simulacrum", "얼음형상",
    M_NO_REGEN,
    MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...
{
    MONS_ZOMBIE_SMALL, 'Z', BROWN, "small zombie", "작은 좀비",
    M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
    9, MONS_ZOMBIE, MONS_ZOMBIE, MH_UNDEAD, -1,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SKELETON_SMALL, 'Z', LIGHTGREY, "small skeleton", "작은 해골",
    M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
    9, MONS_SKELETON, MONS_SKELETON, MH_UNDEAD, -1,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SIMULACRUM_SMALL, 'Z', LIGHTBLUE, "small simulacrum", "작은 얼음형상",
    M_NO_REGEN,
    MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    9, MONS_SIMULACRUM, MONS_SIMULACRUM, MH_UNDEAD, -1,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_ZOMBIE_LARGE, 'Z', YELLOW, "large zombie", "커다란 좀비",
    M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
    9, MONS_ZOMBIE, MONS_ZOMBIE, MH_UNDEAD, -1,
    { {AT_HIT, AF_PLAIN, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SKELETON_LARGE, 'Z', WHITE, "large skeleton", "커다란 해골",
    M_NO_REGEN,
    mrd(MR_RES_COLD, 2),
    9, MONS_SKELETON, MONS_SKELETON, MH_UNDEAD, -1,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SIMULACRUM_LARGE, 'Z', LIGHTCYAN, "large simulacrum", "커다란 얼음형상",
    M_NO_REGEN,
    MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    9, MONS_SIMULACRUM, MONS_SIMULACRUM, MH_UNDEAD, -1,
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SPECTRAL_THING, 'Z', GREEN, "spectral thing", "영체",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_RES_COLD,
...
// water monsters
{
    MONS_ELECTRIC_EEL, ';', LIGHTBLUE, "electric eel", "전기뱀장어",
...
{
    MONS_KRAKEN, 'X', LIGHTMAGENTA, "kraken", "크라켄",
...
{
    MONS_KRAKEN_TENTACLE, 'w', LIGHTMAGENTA, "tentacle", "촉수",
...
{
    MONS_KRAKEN_TENTACLE_SEGMENT, '*', LIGHTMAGENTA, "tentacle segment", "촉수 일부",
...
{
    MONS_OCTOPODE, 'x', LIGHTCYAN, "octopode", "옥토포드",
...
// lava monsters
{
    MONS_LAVA_SNAKE, 'S', LIGHTRED, "lava snake", "용암 뱀",
    M_WARM_BLOOD,
...
{
    MONS_SALAMANDER, 'N', LIGHTRED, "salamander", "샐러맨더",
...
{
    MONS_SALAMANDER_MYSTIC, 'N', YELLOW, "salamander mystic", "샐러맨더 신비술사",
    M_WARM_BLOOD,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
...
// Semi-unique humans ('@')
{
    MONS_HELLBINDER, '@', ETC_FIRE, "Hellbinder", "지옥연결자",
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
...
{
    MONS_CLOUD_MAGE, '@', ETC_SILVER, "Cloud Mage", "구름마법사",
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_PLAYER_ILLUSION, '@', WHITE, "player illusion", "플레이어 환영",
    M_FIGHTER | M_SPEAKS | M_INSUBSTANTIAL | M_NO_POLY_TO | M_FLIES | M_GHOST_DEMON,
    MR_RES_POISON,
...
{
    MONS_PLAYER_SHADOW, 'W', MAGENTA, "shadow", "그림자",
...
// to examine them.
{
    MONS_DANCING_WEAPON, '(', COLOUR_UNDEF, "dancing weapon", "춤추는 무기",
...
{
    MONS_SPECTRAL_WEAPON, '(', GREEN, "spectral weapon", "영체 무기",
...
{
    MONS_ELDRITCH_TENTACLE, 'w', COLOUR_UNDEF, "eldritch tentacle", "으스스한 촉수",
...
{
    MONS_ELDRITCH_TENTACLE_SEGMENT, '*', COLOUR_UNDEF, "eldritch tentacle segment", "으스스한 촉수 일부",
...
// demonspawn ('6')
{
    MONS_DEMONSPAWN, '6', BROWN, "demonspawn", "데몬스폰",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
...
{
    MONS_MONSTROUS_DEMONSPAWN, '6', LIGHTGRAY, "monstrous demonspawn", "흉악한 데몬스폰",
...
{
    MONS_GELID_DEMONSPAWN, '6', BLUE, "gelid demonspawn", "싸늘한 데몬스폰",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    mrd(MR_RES_COLD, 3),
...
{
    MONS_INFERNAL_DEMONSPAWN, '6', RED, "infernal demonspawn", "지옥불 데몬스폰",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    mrd(MR_RES_FIRE, 3),
...
{
    MONS_TORTUROUS_DEMONSPAWN, '6', MAGENTA, "torturous demonspawn", "일그러진 데몬스폰",
...
{
    MONS_BLOOD_SAINT, '6', LIGHTBLUE, "blood saint", "피의 성자",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
...
{
    MONS_WARMONGER, '6', LIGHTCYAN, "warmonger", "전쟁광",
...
{
    MONS_CORRUPTER, '6', LIGHTGREEN, "corrupter", "타락자",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL | MH_DEMONIC, 60,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_BLACK_SUN, '6', LIGHTMAGENTA, "black sun", "검은 태양",
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL | MH_DEMONIC, 60,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_CRIMSON_IMP, '5', RED, "crimson imp", "핏빛 임프",
...
{
    MONS_QUASIT, '5', LIGHTGREY, "quasit", "콰짓",
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD,
...
{
    MONS_WHITE_IMP, '5', WHITE, "white imp", "하얀 임프",
    M_SPEAKS | M_FLIES,
...
{
    MONS_UFETUBUS, '5', LIGHTCYAN, "ufetubus", "우페터버스",
    M_NO_FLAGS,
    MR_VUL_FIRE | MR_RES_COLD,
...
{
    MONS_IRON_IMP, '5', CYAN, "iron imp", "강철 임프",
    M_SPEAKS,
...
{
    MONS_SHADOW_IMP, '5', MAGENTA, "shadow imp", "그림자 임프",
    M_SEE_INVIS | M_SPEAKS,
...
// devils etc. ('4')
{
    MONS_RUST_DEVIL, '4', BROWN, "rust devil", "녹투성이 악마",
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_ELEC | mrd(MR_RES_FIRE, 3) | MR_RES_COLD,
...
{
    MONS_ORANGE_DEMON, '4', LIGHTRED, "orange demon", "오렌지색 악마",
    M_NO_FLAGS,
    MR_NO_FLAGS,
...
{
    MONS_RED_DEVIL, '4', RED, "red devil", "붉은 악마",
    M_FIGHTER | M_FLIES,
    MR_RES_POISON | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
...
{
    MONS_HELLWING, '4', LIGHTGREY, "hellwing", "헬윙",
...
{
    MONS_ICE_DEVIL, '4', WHITE, "ice devil", "얼음의 악마",
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...
{
    MONS_CHAOS_SPAWN, '4', ETC_RANDOM, "chaos spawn", "혼돈의 찌꺼기",
    M_SEE_INVIS,
    MR_NO_FLAGS,
...
// middle demons ('3')
{
    MONS_SUN_DEMON, '3', YELLOW, "sun demon", "태양의 악마",
    M_SEE_INVIS | M_FLIES,
...
{
    MONS_SOUL_EATER, '3', MAGENTA, "soul eater", "영혼포식자",
    M_SEE_INVIS | M_FLIES,
    MR_RES_POISON | MR_RES_COLD,
...
{
    MONS_SMOKE_DEMON, '3', LIGHTGREY, "smoke demon", "연기의 악마",
...
{
    MONS_NEQOXEC, '3', LIGHTMAGENTA, "neqoxec", "네퀘젝",
    M_FLIES,
    MR_RES_POISON,
...
{
    MONS_YNOXINUL, '3', LIGHTCYAN, "ynoxinul", "녹시눌",
    M_SEE_INVIS | M_FLIES,
...
{
    MONS_SIXFIRHY, '3', LIGHTBLUE, "sixfirhy", "식스파이리",
    M_NO_FLAGS,
    mrd(MR_RES_ELEC, 3),
...
{
    MONS_SHADOW_DEMON, '2', MAGENTA, "shadow demon", "그림자 악마",
    M_SEE_INVIS,
    MR_RES_POISON | mrd(MR_RES_COLD, 2),
...
{
    MONS_GREEN_DEATH, '2', GREEN, "green death", "녹색 죽음",
    M_SEE_INVIS,
    MR_RES_POISON,
...
{
    MONS_BLIZZARD_DEMON, '2', LIGHTBLUE, "blizzard demon", "눈보라 악마",
    M_SEE_INVIS | M_FLIES,
...
{
    MONS_CACODEMON, '2', YELLOW, "cacodemon", "캐커데몬",
...
{
    MONS_HELL_BEAST, '2', BROWN, "hell beast", "지옥의 짐승",
    M_FIGHTER,
    MR_NO_FLAGS,
...
{
    MONS_HELLION, '2', LIGHTRED, "hellion", "헬리온",
    M_NO_FLAGS,
...
{
    MONS_REAPER, '2', LIGHTGREY, "reaper", "사신",
    M_FIGHTER | M_SEE_INVIS | M_SPEAKS,
    MR_RES_POISON | MR_RES_COLD,
...
{
    MONS_LOROCYPROCA, '2', BLUE, "lorocyproca", "로코키프로카",
    M_SEE_INVIS | M_INVIS,
...
{
    MONS_TORMENTOR, '2', LIGHTMAGENTA, "tormentor", "고통의 악마",
    M_SPEAKS,
    MR_RES_POISON | MR_RES_FIRE,
...
// fiends, etc. ('1')
{
    MONS_BRIMSTONE_FIEND, '1', LIGHTRED, "Brimstone Fiend", "유황불 핀드",
    M_SEE_INVIS | M_FLIES,
...
{
    MONS_ICE_FIEND, '1', WHITE, "Ice Fiend", "아이스 핀드",
    M_SEE_INVIS | M_FLIES,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...
{
    MONS_TZITZIMITL, '1', MAGENTA, "Tzitzimitl", "치치미틀",
    M_SEE_INVIS | M_FLIES,
...
{
    MONS_HELL_SENTINEL, '1', BROWN, "Hell Sentinel", "지옥의 감시자",
    M_SEE_INVIS | M_SPINY,
    MR_RES_DAMNATION
...
{
    MONS_EXECUTIONER, '1', LIGHTGREY, "Executioner", "처형자",
    M_FIGHTER | M_SEE_INVIS,
...
{
    MONS_SALTLING, '8', WHITE, "saltling", "소금 덩어리",
    M_NO_FLAGS,
    MR_NO_FLAGS,
...
{
    MONS_PEACEKEEPER, '8', YELLOW, "peacekeeper", "평화유지자",
    M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_IRON_GOLEM, '8', CYAN, "iron golem", "강철 골렘",
    M_NO_FLAGS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
...
{
    MONS_CRYSTAL_GUARDIAN, '8', GREEN, "crystal guardian", "수정 수호자",
    M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
...
{
    MONS_TOENAIL_GOLEM, '8', RED, "toenail golem", "발톱 골렘",
    M_NO_FLAGS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_ELECTRIC_GOLEM, '8', LIGHTCYAN, "electric golem", "전기 골렘",
...
{
    MONS_USHABTI, '8', BROWN, "ushabti", "우샤바티",
    M_FIGHTER | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_GUARDIAN_GOLEM, '8', LIGHTGREEN, "guardian golem", "수호자 골렘",
    M_NO_EXP_GAIN,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_SPELLFORGED_SERVITOR, '8', LIGHTMAGENTA, "spellforged servitor", "주문연성 하인",
...
{
    MONS_ICE_STATUE, '8', LIGHTBLUE, "ice statue", "얼음 조각상",
...
{
    MONS_OBSIDIAN_STATUE, '8', MAGENTA, "obsidian statue", "흑요석 조각상",
...
{
    MONS_ORANGE_STATUE, '8', LIGHTRED, "orange crystal statue", "주황색 수정 조각상",
    M_STATIONARY | M_SPEAKS | M_SEE_INVIS,
...
{ // always redefined
    MONS_STATUE, '8', LIGHTGREY, "statue", "조각상",
...
{
    MONS_TRAINING_DUMMY, '8', LIGHTGREY, "training dummy", "훈련용 허수아비",
    M_STATIONARY,
    MR_RES_PETRIFY,
...
{
    MONS_PILLAR_OF_SALT, '8', WHITE, "pillar of salt", "소금 기둥",
    M_NOT_DANGEROUS | M_STATIONARY,
    MR_NO_FLAGS,
...
{
    MONS_BLOCK_OF_ICE, '8', ETC_ICE, "block of ice", "얼음 덩어리",
    M_NOT_DANGEROUS | M_STATIONARY,
...
{
    MONS_DIAMOND_OBELISK, '8', WHITE, "diamond obelisk", "다이아몬드 방첨탑",
...
{
    MONS_LIGHTNING_SPIRE, '8', ETC_ELECTRICITY, "lightning spire", "번개 첨탑",
...
// gargoyles ('9')
{
    MONS_GARGOYLE, '9', LIGHTGREY, "gargoyle", "가고일",
    M_FLIES,
...
{
    MONS_WAR_GARGOYLE, '9', CYAN, "war gargoyle", "전쟁 가고일",
...
{
    MONS_MOLTEN_GARGOYLE, '9', RED, "molten gargoyle", "녹아내린 가고일",
    M_FLIES,
...
{
    MONS_PANDEMONIUM_LORD, '&', COLOUR_UNDEF, "pandemonium lord", "판데모니움 군주",
...
{
    MONS_BALL_LIGHTNING, '*', LIGHTCYAN, "ball lightning", "번개 구체",
...
{
    MONS_BALLISTOMYCETE_SPORE, '*', GREEN, "ballistomycete spore", "폭발성 포자",
...
{
    MONS_LOST_SOUL, '*', LIGHTGREEN, "lost soul", "길잃은 영혼",
...
{
    MONS_LURKING_HORROR, '*', BLUE, "lurking horror", "잠복한 공포",
...
{
    MONS_ORB_OF_FIRE, '*', RED, "orb of fire", "화염의 보주",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
...
{ // not an actual monster, used by a spell
    MONS_ORB_OF_DESTRUCTION, '*', WHITE, "orb of destruction", "파괴의 보주",
...
{ // not an actual monster, used by a spell
    MONS_FULMINANT_PRISM, '*', ETC_MAGIC, "fulminant prism", "폭발성 프리즘",
...
{
    MONS_WRETCHED_STAR, '*', MAGENTA, "wretched star", "뒤틀린 별",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
...
{
    MONS_BATTLESPHERE, '*', ETC_MAGIC, "battlesphere", "전투구체",
...
// other symbols
{
    MONS_DEATH_COB, 'z', YELLOW, "death cob", "죽음의 옥수수",
    M_SPEAKS,
    MR_RES_COLD,
...
// "A"ngels.
{
    MONS_MENNAS, 'A', LIGHTCYAN, "Mennas", "메나스",
...
// "c"entaurs.
{
    MONS_NESSOS, 'c', MAGENTA, "Nessos", "네소스",
...
{
    MONS_POLYPHEMUS, 'C', GREEN, "Polyphemus", "폴리페무스",
...
{
    MONS_ANTAEUS, 'C', LIGHTCYAN, "Antaeus", "안타이오스",
...
// "d"raconians.
{
    MONS_TIAMAT, 'd', COLOUR_UNDEF, "Tiamat", "티아마트",
...
{
    MONS_BAI_SUZHEN, 'd', LIGHTBLUE, "Bai Suzhen", "백소정",
...
{
    MONS_LERNAEAN_HYDRA, 'D', YELLOW, "the Lernaean hydra", "레르나의 히드라",
...
{
    MONS_SERPENT_OF_HELL, 'D', ETC_FIRE, "the Serpent of Hell", "지옥의 고룡",
...
{
    MONS_SERPENT_OF_HELL_COCYTUS, 'D', ETC_ICE, "the Serpent of Hell", "지옥의 고룡",
    M_SEE_INVIS | M_UNIQUE | M_CRASH_DOORS | M_FLIES | M_TALL_TILE,
...
{
    MONS_SERPENT_OF_HELL_DIS, 'D', ETC_IRON, "the Serpent of Hell", "지옥의 고룡",
...
{
    MONS_SERPENT_OF_HELL_TARTARUS, 'D', ETC_DEATH, "the Serpent of Hell", "지옥의 고룡",
    M_SEE_INVIS | M_UNIQUE | M_CRASH_DOORS | M_FLIES | M_TALL_TILE,
    MR_RES_POISON | mrd(MR_RES_COLD, 2),
...
{
    MONS_BAI_SUZHEN_DRAGON, 'D', ETC_ELECTRICITY, "Bai Suzhen", "백소정",
    M_UNIQUE | M_SEE_INVIS | M_COLD_BLOOD | M_SPEAKS | M_FEMALE | M_FLIES,
    mrd(MR_RES_ELEC, 3) | MR_RES_COLD | MR_RES_POISON,
...
// "e"lves
{
    MONS_DUVESSA, 'e', BLUE, "Duvessa", "듀베사",
...
{
    MONS_FANNAR, 'e', LIGHTBLUE, "Fannar", "판나르",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
// "F"rogs.
{
    MONS_PRINCE_RIBBIT, 'F', LIGHTCYAN, "Prince Ribbit", "개굴 왕자",
...
{
    MONS_ROBIN, 'g', LIGHTCYAN, "Robin", "로빈",
...
{
    MONS_CRAZY_YIUF, 'g', COLOUR_UNDEF, "Crazy Yiuf", "미치광이 이우프",
    M_WARM_BLOOD | M_SPEAKS | M_UNIQUE | M_MALE,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 10,
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_JORGRUN, 'g', LIGHTMAGENTA, "Jorgrun", "요르그룬",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
{
    MONS_NATASHA, 'h', MAGENTA, "Natasha", "나타샤",
...
// "H"ybrids.
{
    MONS_ARACHNE, 'H', LIGHTCYAN, "Arachne", "아라크네",
...
{
    MONS_ASTERION, 'H', LIGHTBLUE, "Asterion", "아스테리온",
...
// Spr"i"ggans.
{
    MONS_AGNES, 'i', LIGHTCYAN, "Agnes", "아그네스",
...
{
    MONS_THE_ENCHANTRESS, 'i', LIGHTMAGENTA, "the Enchantress", "인챈트리스",
...
// "J"ellies.
{
    MONS_ROYAL_JELLY, 'J', YELLOW, "the Royal Jelly", "로얄 젤리",
...
{
    MONS_DISSOLUTION, 'J', LIGHTMAGENTA, "Dissolution", "용해자",
...
// "M"ummies.
{
    MONS_MENKAURE, 'M', MAGENTA, "Menkaure", "멘카우레",
...
{
    MONS_KHUFU, 'M', LIGHTRED, "Khufu", "쿠푸",
...
// "m"erfolk.
{
    MONS_ILSUIW, 'm', LIGHTGREEN, "Ilsuiw", "일스이우",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...
// "N"agas.
{
    MONS_VASHNIA, 'N', LIGHTCYAN, "Vashnia", "바쉬니아",
...
// "O"gres.
{
    MONS_EROLCHA, 'O', LIGHTBLUE, "Erolcha", "에롤차",
...
// "o"rcs.
{
    MONS_BLORK_THE_ORC, 'o', BROWN, "Blork the orc", "오크 블로크",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
{
    MONS_NERGALLE, 'o', WHITE, "Nergalle", "네르갈",
    M_UNIQUE | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...
{
    MONS_SAINT_ROKA, 'o', LIGHTBLUE, "Saint Roka", "성자 로카",
...
// Tengu.
{
    MONS_SOJOBO, 'Q', LIGHTGREEN, "Sojobo", "소조보",
...
{
    MONS_AZRAEL, 'R', LIGHTRED, "Azrael", "아즈라엘",
...
{
    MONS_MARA, 'R', LIGHTMAGENTA, "Mara", "마라",
    M_SEE_INVIS | M_SPEAKS | M_UNIQUE | M_MALE,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2),
...
{
    MONS_AIZUL, 'S', LIGHTMAGENTA, "Aizul", "아이줄",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_UNIQUE | M_FEMALE,
    MR_RES_POISON,
...
// "T"rolls.
{
    ...
    MONS_SNORG, 'T', LIGHTGREEN, "Snorg", "스노그",
...
{
    MONS_MOON_TROLL, 'T', LIGHTCYAN, "moon troll", "달빛 트롤",
...
{
    MONS_GASTRONOK, 'w', MAGENTA, "Gastronok", "가스트로녹",
...
// Elephants.
{
    MONS_NELLIE, 'Y', LIGHTMAGENTA, "Nellie", "넬리",
...
// Skulls and "z" undead.
{
    MONS_MURRAY, 'z', LIGHTRED, "Murray", "머레이",
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_MALE,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC,
...
// numbers!
{
    MONS_IGNACIO, '1', LIGHTMAGENTA, "Ignacio", "이그나시오",
...
{
    MONS_GRINDER, '5', BLUE, "Grinder", "그라인더",
...

{
    ...
    MONS_ROXANNE, '8', BLUE, "Roxanne", "록산느",
...
// human uniques
{
    MONS_TERENCE, '@', LIGHTCYAN, "Terence", "테렌스",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
{
    MONS_JESSICA, '@', LIGHTGREY, "Jessica", "제시카",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...
{
    MONS_SIGMUND, '@', YELLOW, "Sigmund", "시그문드",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
{
    MONS_PSYCHE, '@', LIGHTMAGENTA, "Psyche", "프시케",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...
{
    MONS_JOSEPHINE, '@', WHITE, "Josephine", "조세핀",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    mrd(MR_RES_NEG, 3),
...
{
    MONS_HAROLD, '@', LIGHTGREEN, "Harold", "해롤드",
...
{
    MONS_LOUISE, '@', LIGHTMAGENTA, "Louise", "루이즈",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...
{
    MONS_FRANCES, '@', YELLOW, "Frances", "프랜시스",
...
{
    MONS_RUPERT, '@', LIGHTRED, "Rupert", "루퍼트",
...
{
    MONS_KIRKE, '@', LIGHTBLUE, "Kirke", "키르케",
...
{
    MONS_FREDERICK, '@', GREEN, "Frederick", "프레데릭",
    M_UNIQUE | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
{
    MONS_MARGERY, '@', LIGHTRED, "Margery", "마저리",
    M_UNIQUE | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
...
{
    MONS_EUSTACHIO, '@', BLUE, "Eustachio", "유스타키오",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...
{
    MONS_MAURICE, '@', GREEN, "Maurice", "모리스",
...
{
    MONS_NIKOLA, '@', LIGHTCYAN, "Nikola", "니콜라",
    ...
    // unique major demons ('&')
{
    MONS_MNOLEG, '&', LIGHTGREEN, "Mnoleg", "므놀렉",
...
{
    MONS_LOM_LOBON, '&', LIGHTBLUE, "Lom Lobon", "롬 로본",
...
{
    MONS_GLOORX_VLOQ, '&', LIGHTGREY, "Gloorx Vloq", "글룩스 블로크",
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_FLIES | M_TALL_TILE,
...
{
    MONS_DISPATER, '&', MAGENTA, "Dispater", "디스페이터",
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_TALL_TILE,
...
{
    MONS_ASMODEUS, '&', LIGHTRED, "Asmodeus", "아스모데우스",
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_MALE | M_FLIES | M_TALL_TILE,
...
{
    MONS_ERESHKIGAL, '&', WHITE, "Ereshkigal", "에레쉬키갈",
...
// over and over.
{
    MONS_TEST_SPAWNER, 'X', WHITE, "test spawner", "테스트용 생성기",
...
{
    MONS_SENSED, '{', RED, "sensed monster", "감지된 적",
    M_CANT_SPAWN,
    MR_NO_FLAGS,
...
{
    MONS_SENSED_FRIENDLY, '{', GREEN, "friendly sensed monster", "감지된 아군",
    M_CANT_SPAWN,
    MR_NO_FLAGS,
    0, MONS_SENSED, MONS_SENSED, MH_NONLIVING, 0,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SENSED_TRIVIAL, '{', BLUE, "trivial sensed monster", "감지된 손쉬운 적",
    M_CANT_SPAWN,
    MR_NO_FLAGS,
    0, MONS_SENSED, MONS_SENSED, MH_NONLIVING, 0,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SENSED_EASY, '{', LIGHTGRAY, "easy sensed monster", "감지된 약한 적",
    M_CANT_SPAWN,
    MR_NO_FLAGS,
    0, MONS_SENSED, MONS_SENSED, MH_NONLIVING, 0,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SENSED_TOUGH, '{', YELLOW, "tough sensed monster", "감지된 까다로운 적",
    M_CANT_SPAWN,
    MR_NO_FLAGS,
    0, MONS_SENSED, MONS_SENSED, MH_NONLIVING, 0,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...
{
    MONS_SENSED_NASTY, '{', LIGHTRED, "nasty sensed monster", "감지된 어려운 적",
    M_CANT_SPAWN,
    MR_NO_FLAGS,
    0, MONS_SENSED, MONS_SENSED, MH_NONLIVING, 0,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
