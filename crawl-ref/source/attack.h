...
public:
    ...
    string defender_name(bool allow_reflexive, string postposition);
...
protected:
    ...
    string atk_name(string postposition = "", description_level_type desc = DESC_PLAIN);
    string def_name(description_level_type desc);
    string def_name(string postposition = "", description_level_type desc = DESC_PLAIN);
